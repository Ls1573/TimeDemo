...
-keep class com.time.memory.dao.DBManager{ *; }
-keep class com.time.memory.dao.MySQLiteOpenHelper{ *; }
-keep class com.time.memory.dao.MigrationHelper { *; }
...
-keep class com.github.yuweiguocn.library.**{*;}
...
-dontwarn com.github.yuweiguocn.library.**
