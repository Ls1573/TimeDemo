package com.time.memory.gui.togglebutton.button;
...
import com.time.memory.gui.togglebutton.SimpleSpringListener;
...
import com.time.memory.gui.togglebutton.SpringUtil;
...
public class ToggleButton extends View {
	 ...
	 * 开启颜色
	 */
	private int onColor = getResources().getColor(R.color.green_46);
	/**
	 * 关闭颜色
	 */
	...
	public void setup(AttributeSet attrs) {
		...
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_bWidth, borderWidth);
