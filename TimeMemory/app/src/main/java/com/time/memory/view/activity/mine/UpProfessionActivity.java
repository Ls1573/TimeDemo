 ...
 * @version V1.0
 * @Description:修改行业
 * @date 2016-9-23上午11:28:10
 * ==============================
 */
public class UpProfessionActivity extends BaseActivity implements IBaseView {

	@Bind(R.id.update_uppression_et)
	ClearEditText update_uppression_et;

	@Override
	public void onCreateMyView() {
		setContentView(R.layout.activity_upcompany);
	}
	...
	public void initView() {
		initTopBarForBoth(getString(R.string.app_profession), R.drawable.image_back, getString(R.string.app_save), -1);
	}

	@Override
	public void initData() {
		String profession = getIntent().getStringExtra("profession");
		update_uppression_et.setText(TextUtils.isEmpty(profession) ? "" : profession);
	}
	...
	public void onClick(View view) {
		...
		if (view.getId() == R.id.tv_main_right) {
			//返回
			setResultBack(ReqConstant.PRESISSION, update_uppression_et.getText().toString());
		}
	}
	...
	private void setResultBack(int resultCode, String address) {
		...
		intent.putExtra("presission", address);
