 ...
 * ==============================
 */
public class DeleteCircleAdapter extends BaseAdapter {
	...
	private OnFriendCallBack onFriendCallBack;
	private String imgOss;

	public DeleteCircleAdapter(Context mContext, List<GroupContacts> GroupContacts) {
	...
	public void setOnFriendCallBack(OnFriendCallBack onFriendCallBack) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		if (view == null) {
			//所有
			view = inflater.inflate(R.layout.item_delcircle, parent, false);
		...
		holder.circle_check.setSelected(GroupContacts.get(position).isCheck());
		holder.circle_pic_ll.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				onFriendCallBack.onChooseBack(position);
			}
		});
		return view;
	}
