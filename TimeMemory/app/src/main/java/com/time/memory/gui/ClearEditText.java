 ...
 * @author Qiu
 * @version 1.0
 * @Package com.exesc.secondcar.ui.gui
 * @Description: 自定义带删除按钮的EditText
 * @date 2016-9-4 下午5:25:55
 * ==============================
 */
public class ClearEditText extends EditText implements OnFocusChangeListener,
	...
	private void init() {
		// 获取EditText的DrawableRight,没有设置我们就使用默认的图片,获取图片的顺序是左上右下（0,1,2,3,）
...
//		CLog.e(TAG, "event.getAction():" + event.getAction());
