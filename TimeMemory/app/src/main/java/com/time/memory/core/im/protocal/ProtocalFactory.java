 ...
 * 
 * ProtocalFactory.java at 2016-2-20 11:06:06, code by Jack Jiang.
...
import com.time.memory.core.im.protocal.c.PKeepAlive;
import com.time.memory.core.im.protocal.c.PLoginInfo;
import com.time.memory.core.im.protocal.s.PErrorResponse;
import com.time.memory.core.im.protocal.s.PKeepAliveResponse;
import com.time.memory.core.im.protocal.s.PLoginInfoResponse;
...
//		LogUtil.LogShitou(dataContentOfProtocal);
		return new Gson().fromJson(dataContentOfProtocal.trim(), clazz);
	}
