...
public class PhotoFolderInfo implements Serializable {
	...
	private int photoSize;//图片数量
	private String photoThumbl;//封面
	...
	public String getPhotoThumbl() {
		return photoThumbl;
	}

	public void setPhotoThumbl(String photoThumbl) {
		this.photoThumbl = photoThumbl;
	}
}
