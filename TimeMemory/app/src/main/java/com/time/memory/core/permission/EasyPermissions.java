 ...
 */
package com.time.memory.core.permission;
...
//			dialog.show();
	...
	private static void runAnnotatedMethods(Object object, int requestCode) {
		...
		for (Method method : clazz.getDeclaredMethods()) {
			if (method.isAnnotationPresent(com.time.memory.core.permission.AfterPermissionGranted.class)) {
				// Check for annotated methods with matching request code.
				com.time.memory.core.permission.AfterPermissionGranted ann = method.getAnnotation(com.time.memory.core.permission.AfterPermissionGranted.class);
