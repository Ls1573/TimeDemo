package com.time.memory.gui.swipback.swipeback.transformer;

import android.app.Activity;
import android.view.View;

import com.time.memory.gui.swipback.swipeback.SwipeBack;
 ...
 * Also {@link #onSwipeBackCompleted(com.hannesdorfmann.swipeback.SwipeBack, Activity)} will be called
...
public interface SwipeBackTransformer {
	 ...
	 * visible, only the main activity layout is visible. This is done if the user closes the swipe back view before it was completed {@link #onSwipeBackCompleted(Activity)}.
	 * @param  swipeBack The reference to the SwipeBack object
	 * @param activity Tha activity the swipe back is attached to
	 */
