...
public class CoreConfig {
	...
	private CoreConfig(Builder builder) {
		...
		if (takePhotoFolder == null) {
			takePhotoFolder = new File(Environment.getExternalStorageDirectory(), "/DCIM/" + "MT/");
//			takePhotoFolder = AttPathUtils.getInternalDir();
		}
		...
		if (editPhotoCacheFolder == null) {
			editPhotoCacheFolder = new File(Environment.getExternalStorageDirectory() + "/MT/edittemp/");
//			editPhotoCacheFolder = AttPathUtils.getInternalDir();
		}
