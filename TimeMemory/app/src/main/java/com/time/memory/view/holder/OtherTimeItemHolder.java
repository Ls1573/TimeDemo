 ...
 */
public class OtherTimeItemHolder extends BaseHolder<OtherMemorys> {
	...
	public OtherTimeItemHolder(View itemView) {
		super(itemView);
	...
	public void setData(final OtherMemorys memory) {
		...
		// 未读追加记忆数
		if (memory.getMemory().getUnReadMPointAddCnt() != 0) {
			time_unread_ll.setVisibility(View.VISIBLE);
			time_unreadnum_tv.setText(String.valueOf(memory.getMemory().getUnReadMPointAddCnt()));
		} else {
