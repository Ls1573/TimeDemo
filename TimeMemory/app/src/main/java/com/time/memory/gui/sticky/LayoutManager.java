...
public class LayoutManager extends RecyclerView.LayoutManager {
	...
	private ArrayMap<String, SectionLayoutManager> mSlms;
...
//            Log.d("trim", "index " + i + " position " + getPosition(getChildAt(0)));
	...
	public static class Builder {
		...
		ArrayMap<String, SectionLayoutManager> slms = new ArrayMap<>();
	...
	private class LayoutHelperDelegate implements LayoutHelper.Parent {
		...
		public int getPosition(View child) {
			...
			try {
				...
				index = mLayoutManager.getPosition(child);
				return index;
			} catch (Exception e) {
				e.printStackTrace();
				return -1;
